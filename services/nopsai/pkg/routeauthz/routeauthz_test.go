...
func TestMapRequestUsesUpdatedLowLevelActions(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "agent profiles read uses agent profile system resource",
			method:     http.MethodGet,
		...
		{
			name:       "agent profile delete uses agent profile system resource",
			method:     http.MethodDelete,
		...
		{
			name:       "agent profile default update uses agent profile system resource",
			method:     http.MethodPut,
		...
		{
			name:       "group notifications read uses group path",
			method:     http.MethodGet,
			path:       "/v1/groups/team-1/notifications",
			wantAction: "config_repo.read",
			wantType:   "folder",
			wantID:     "team-1",
		},
		{
			name:       "group notifications manage uses group path",
			method:     http.MethodPut,
			path:       "/v1/groups/team-1/notifications",
			wantAction: "config_repo.manage",
			wantType:   "folder",
		...
		{
			name:       "team list uses folder filter during compatibility",
			method:     http.MethodGet,
			path:       "/v1/teams",
			wantAction: "folder.list",
			wantType:   "folder",
		...
		{
			name:       "team detail uses folder read",
			method:     http.MethodGet,
			path:       "/v1/teams/team-1",
			wantAction: "folder.read",
			wantType:   "folder",
			wantID:     "team-1",
		},
		{
			name:       "team applications use folder read",
			method:     http.MethodGet,
		...
		{
			name:       "team LLM profile read uses folder read",
			method:     http.MethodGet,
		...
		{
			name:       "team LLM profile write uses folder update",
			method:     http.MethodPut,
			path:       "/v1/teams/team-1/llm-profiles/standard",
			wantAction: "folder.update",
			wantType:   "folder",
			wantID:     "team-1",
		},
		{
		...
		{
			name:       "team MCP profile read uses folder read",
			method:     http.MethodGet,
		...
		{
			name:       "team MCP profile alias write uses folder update",
			method:     http.MethodPost,
