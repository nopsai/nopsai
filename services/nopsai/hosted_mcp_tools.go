...
func allHostedMCPTools() []hostedMCPTool {
	tools := []hostedMCPTool{
		...
		toolDef("nopsai.get_knowledge_context", "Read a managed knowledge context document by id, kind/name, kind/team/name, or kind plus ref.", "knowledge_context.read", "knowledge_context", "*", objectSchema(map[string]any{"id": stringSchema(), "kind": stringSchema(), "team": stringSchema(), "team_path": stringSchema(), "name": stringSchema(), "ref": stringSchema()})),
