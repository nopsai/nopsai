...
func hostedMCPFinalTools() []hostedMCPTool {
	...
	return []hostedMCPTool{
		...
		toolDef("nopsai.eject_runner", "Remove a runner registration from dispatcher status and disconnect live runner streams. Requires confirm:true.", "system.update", "dispatcher", "runners", objectSchema(map[string]any{"runner_id": stringSchema(), "confirm": booleanSchema()})),
