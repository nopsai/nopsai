...
func (a *App) registerTeamRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /v1/teams/{teamID}/config-repository/sync/cancel", a.handleTeamConfigRepository)
	...
	mux.HandleFunc("POST /v1/teams/{teamID}/config-repository/validate", a.handleTeamConfigRepository)
	...
	mux.HandleFunc("GET /v1/teams/{teamID}/models", a.handleListTeamLLMProfiles)
	mux.HandleFunc("PUT /v1/teams/{teamID}/models", a.handleReplaceTeamLLMProfiles)
	mux.HandleFunc("PUT /v1/teams/{teamID}/models/default", a.handleSetTeamDefaultLLMProfile)
	mux.HandleFunc("PUT /v1/teams/{teamID}/models/{profileName}", a.handleUpsertTeamLLMProfile)
	mux.HandleFunc("DELETE /v1/teams/{teamID}/models/{profileName}", a.handleDeleteTeamLLMProfile)
	mux.HandleFunc("GET /v1/teams/{teamID}/agent-roles", a.handleListTeamAgentProfiles)
	mux.HandleFunc("POST /v1/teams/{teamID}/agent-roles", a.handleCreateTeamAgentProfile)
	mux.HandleFunc("PUT /v1/teams/{teamID}/agent-roles/default", a.handleSetTeamDefaultAgentProfile)
	mux.HandleFunc("GET /v1/teams/{teamID}/agent-roles/{profileID}", a.handleGetTeamAgentProfile)
	mux.HandleFunc("PUT /v1/teams/{teamID}/agent-roles/{profileID}", a.handleUpsertTeamAgentProfile)
	mux.HandleFunc("DELETE /v1/teams/{teamID}/agent-roles/{profileID}", a.handleDeleteTeamAgentProfile)
...
func (a *App) registerSystemRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /v1/system/agent-roles", a.handleListAgentProfiles)
	mux.HandleFunc("POST /v1/system/agent-roles", a.handleCreateAgentProfile)
	mux.HandleFunc("POST /v1/system/agent-roles/validate", a.handleValidateAgentProfile)
	mux.HandleFunc("PUT /v1/system/agent-roles/default", a.handleSetDefaultAgentProfile)
	mux.HandleFunc("GET /v1/system/agent-roles/{profileID}", a.handleGetAgentProfile)
	mux.HandleFunc("PUT /v1/system/agent-roles/{profileID}", a.handleUpsertAgentProfile)
	mux.HandleFunc("DELETE /v1/system/agent-roles/{profileID}", a.handleDeleteAgentProfile)
	mux.HandleFunc("GET /v1/system/agent-roles/{profileID}/usage", a.handleGetAgentProfileUsage)
	...
	mux.HandleFunc("POST /v1/system/config/sync/cancel", a.handleCancelConfigSync)
	...
	mux.HandleFunc("POST /v1/system/config-repo/sync/cancel", a.handleCancelGlobalConfigRepositorySync)
	...
	mux.HandleFunc("POST /v1/system/config-repo/validate", a.handleValidateGlobalConfigRepository)
	...
	mux.HandleFunc("POST /v1/system/config-repos/sync/cancel", a.handleCancelConfigSync)
...
func (a *App) registerPipelineRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /v1/pipelines/validate", a.handleValidatePipeline)
	...
	mux.HandleFunc("POST /v1/steps/validate", a.handleValidateReusableStep)
	...
	mux.HandleFunc("POST /v1/overrides/validate", a.handleValidateTriggerOverride)
...
func (a *App) registerDashboardRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("PATCH /v1/dashboards/{dashboardID}/sections/{sectionID}", a.handleUpdateDashboardSection)
	mux.HandleFunc("DELETE /v1/dashboards/{dashboardID}/sections/{sectionID}", a.handleDeleteDashboardSection)
...
func (a *App) registerRunRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /v1/runs/{runID}/outputs/{outputID}/retry", a.handleRetryRunFinalOutput)
	mux.HandleFunc("POST /v1/runs/{runID}/outputs/{outputID}/cancel", a.handleCancelRunFinalOutput)
