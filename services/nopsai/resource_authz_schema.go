...
var resourceAuthorizationSchemaStatements = []string{
	...
	`UPDATE pipelines SET visibility = 'team' WHERE visibility = '' OR visibility IS NULL`,
	...
	`UPDATE steps SET visibility = 'team' WHERE visibility = '' OR visibility IS NULL`,
	...
	`UPDATE triggers SET visibility = 'team' WHERE visibility = '' OR visibility IS NULL`,
	...
	`UPDATE config_repositories SET visibility = 'team' WHERE visibility = '' OR visibility IS NULL`,
	...
	`UPDATE resource_visibility SET visibility = 'team' WHERE visibility = '' OR visibility IS NULL`,
