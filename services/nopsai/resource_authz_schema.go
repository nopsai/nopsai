...
var resourceAuthorizationSchemaStatements = []string{
	...
	`UPDATE pipelines SET visibility = 'team' WHERE visibility = 'group' OR visibility = '' OR visibility IS NULL`,
	`ALTER TABLE pipelines ALTER COLUMN visibility SET DEFAULT 'team'`,
	`ALTER TABLE pipelines ALTER COLUMN visibility SET NOT NULL`,
	...
	`UPDATE steps SET visibility = 'team' WHERE visibility = 'group' OR visibility = '' OR visibility IS NULL`,
	`ALTER TABLE steps ALTER COLUMN visibility SET DEFAULT 'team'`,
	`ALTER TABLE steps ALTER COLUMN visibility SET NOT NULL`,
	...
	`UPDATE triggers SET visibility = 'team' WHERE visibility = 'group' OR visibility = '' OR visibility IS NULL`,
	`ALTER TABLE triggers ALTER COLUMN visibility SET DEFAULT 'team'`,
	`ALTER TABLE triggers ALTER COLUMN visibility SET NOT NULL`,
	...
	`UPDATE config_repositories SET visibility = 'team' WHERE visibility = 'group' OR visibility = '' OR visibility IS NULL`,
	`ALTER TABLE config_repositories ALTER COLUMN visibility SET DEFAULT 'team'`,
	`ALTER TABLE config_repositories ALTER COLUMN visibility SET NOT NULL`,
	...
	`UPDATE resource_visibility SET visibility = 'team' WHERE visibility = 'group' OR visibility = '' OR visibility IS NULL`,
	`ALTER TABLE resource_visibility ALTER COLUMN visibility SET DEFAULT 'team'`,
	`ALTER TABLE resource_visibility ALTER COLUMN visibility SET NOT NULL`,
