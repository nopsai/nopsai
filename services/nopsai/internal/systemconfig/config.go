...
var FieldMetadataByKey = map[string]FieldMetadata{
	...
	"cors_allowed_origins":             runtimeLive("CORS allowed origins", "General"),
	"metrics_require_auth":             runtimeLive("Metrics require auth", "General"),
	...
	"runtime_output_max_bytes":     nextRunOnly("Runtime output max bytes", "Runtime"),
	...
	"ejected_runner_ids":                runtimeLive("Revoked runner IDs", "Dispatcher"),
...
func BuildResponse(cfg config.Config, envFilePath string) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"metrics_require_auth":              cfg.MetricsRequireAuth,
