...
export const baseSystemSubNav: NavItem[] = [
  ...
  { label: 'Installation', path: '/system/setup', icon: <ObjectIcon type="setup" /> },
...
export const descriptionMap: Record<string, string> = {
  ...
  'models': 'Manage approved model providers and defaults.',
  'agent-roles': 'Manage reusable agent roles, behavior, and runtime permissions.',
