...
const sections: DocSection[] = [
  ...
  },
  {
    ...
    articles: [
      { id: 'docker-install', title: 'Docker installation', level: 'Start', summary: 'Single-node install with compose, persistent storage, TLS, health checks, and local runner execution.', bullets: ['Prepare Compose environment and secrets.', 'Start API, UI, database, Redis, dispatcher, and runners.', 'Validate health endpoints and first run.'] },
