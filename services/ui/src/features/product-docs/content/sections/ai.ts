  ...
  articles: [
    {
      ...
      keyFacts: [
        '**Agent role** controls persona, role, and prompt instructions. It does not control provider, model, secrets, tools, credentials, or permissions.',
        '**Model** controls provider, model, endpoint, credential reference, timeout, tokens, and temperature. It does not control persona, authorization, Knowledge Context, or MCP server definitions.',
      ...
      details: [
        'Resolution order for conditions and LLM-backed tasks: task `model`, then step, then pipeline, then the configured default. Final outputs resolve item, then `output.model`, then pipeline, then default. Agent role resolves step, then pipeline, then default.',
      ...
      examples: [
        {
          ...
          language: 'text',
          code: [
            'Can a task set agent_role?            No. Pipeline and step only.',
            'Does steps[].model grant access?  No. AAA and scope still decide.',
      ...
      related: ['agent-roles', 'models', 'mcp', 'knowledge-context', 'governance-and-policy'],
      sources: [
    ...
    },
    {
      ...
      related: ['ai-control-layers', 'models', 'teams-and-ownership'],
      sources: [
        { repositoryPath: 'pkg/models/agent_role.go', purpose: 'Agent role struct and defaults.' },
        { repositoryPath: 'doc/agent-roles.md', purpose: 'GitOps management, AAA, and runtime prompt behavior.' },
      ],
    },
    {
      id: 'models',
