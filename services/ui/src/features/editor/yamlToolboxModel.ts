...
const pipelineParameterGroups: YamlToolboxParameterGroup[] = [
  {
    ...
    parameters: [
      ...
      { key: 'agent_role', description: 'Pipeline-level AI persona.', valueHint: 'approved agent profile name' },
      { key: 'model', description: 'Pipeline-level model profile.', valueHint: 'approved LLM profile name' },
...
const stepParameterGroup: YamlToolboxParameterGroup = {
  ...
  parameters: [
    ...
    { key: 'agent_role', description: 'Step persona override.' },
    { key: 'model', description: 'Step model profile override.' },
...
const taskParameterGroup: YamlToolboxParameterGroup = {
  ...
  parameters: [
    ...
    { key: 'model', description: 'Most-specific model profile for a goal task.' },
