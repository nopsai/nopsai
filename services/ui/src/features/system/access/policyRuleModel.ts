...
export const AAA_RESOURCE_TYPE_CONFIGS: AAAResourceTypeConfig[] = [
  ...
  },
  {
    ...
    presets: [
      ...
      { value: 'models', label: 'LLM profiles' },
      { value: 'agent-roles', label: 'Agent profiles' },
      { value: 'mcp', label: 'MCP' },
...
const AAA_ALL_ACTION_OPTION_TEAMS: AAAOptionTeam[] = [
  ...
  },
  {
    label: 'AI Profiles',
    options: [
      { value: 'model.read', label: 'read LLM profile' },
      { value: 'model.use', label: 'use LLM profile' },
      { value: 'model.manage_acl', label: 'manage LLM access' },
      { value: 'agent_role.read', label: 'read agent profile' },
      { value: 'agent_role.use', label: 'use agent profile' },
      { value: 'agent_role.manage_acl', label: 'manage agent access' },
...
const AAA_ACTION_OPTION_TEAMS_BY_SELECTOR: Record<string, AAAOptionTeam[]> = {
  ...
  'system:models': [{ label: 'System actions', options: [{ value: 'system.read', label: 'read' }, { value: 'system.update', label: 'update' }] }],
  'system:agent-roles': [{ label: 'System actions', options: [{ value: 'system.read', label: 'read' }, { value: 'system.update', label: 'update' }] }],
...
const AAA_ACTION_OPTION_TEAMS_BY_RESOURCE_TYPE: Record<string, AAAOptionTeam[]> = {
  ...
  model: [{ label: 'LLM profile actions', options: aiProfileActionOptions('model.') }],
  agent_role: [{ label: 'Agent profile actions', options: aiProfileActionOptions('agent_role.') }],
