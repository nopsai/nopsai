...
- [runtime-flows.md](./runtime-flows.md): Step-by-step execution flows for webhooks, manual runs, dispatching, agent execution, child pipelines, cancellation, and config sync.
...
- [api.md](./api.md): REST and WebSocket API guide.
...
3. `runtime-flows.md`
4. `feature-reference.md`
5. `decision-architecture.md`
