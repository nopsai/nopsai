...
- `users`, `user_roles`, `role_permissions`, `refresh_tokens`, `personal_access_tokens`, `audit_logs`: Local auth, legacy RBAC metadata, session, personal API credentials, and audit data.
