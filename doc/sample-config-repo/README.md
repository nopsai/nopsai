...
`^[A-Za-z0-9_.-]+$`; repository-scoped entries use `owner/repo/NAME`.
...
team-1-repo/pipelines/variable-feature-exercise.yaml
...
team-1-repo/pipelines/variable-feature-child.yaml
...
team-1-repo/steps/shared/variable-defaults.yaml
